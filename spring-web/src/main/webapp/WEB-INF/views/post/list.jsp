...
$(function(){
	...
	$("#table-posts a[data-user-id]").click(function(event){
		...
		$.getJSON('/user/detail.json', {userId: id}, function(user){
			...
			modal.show();
			/*
				response 변수에 대입되어 있는 객체는 아래와 같다.
				{
					"id":"ryu",
					"name":"류관순",
					"email":"ryu@naver.com",
					...
					"userRoles":[
									{"userId":"ryu","roleName":"ROLE_GUEST"},
									{"userId":"ryu","roleName":"ROLE_USER"}]}
			*/
		})
