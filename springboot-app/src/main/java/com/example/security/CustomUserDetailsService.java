 ...
 * UserDetailsService 인터페이스의 loadUserByUsername(String username) 메소드를 구현한 클래스다 <br />
 ...
 * UserDetailService 인터페이스의 구현클래스에 재정의 loadUserByUsername(String username) 메소드가 반환하는 UserDetails 구현객체가
 * 인증과정에서 사용된다.
 * 
...
public class CustomUserDetailsService implements UserDetailsService {
	...
	// 사용자 정보와 사용자 권한 정보를 조회하기 위해서 UserMapper와 UserRoleMapper를 주입받는다.
	@Autowired
	...
	public UserDetails loadUserByUsername(String userId) throws UsernameNotFoundException {
		...
		// 조회된 권한정보로 GrantedAuthority 객체를 생성한다.
